...
const tareaSchema = new mongoose.Schema({
  ...
  _id: { type: mongoose.Schema.Types.Mixed }, // acepta ObjectId Y string

  usuario_id: { type: String, required: true },
  titulo: { type: String, required: true },
  descripcion: { type: String, default: "" },
  tipo: { type: String, default: "tarea" },
  ...
  color: { type: String, default: "#39d0c3" },
  es_evento: { type: Boolean, default: true },
  recordatorio: { type: Boolean, default: true },
  repetir: { type: String, default: "none" },
  notas: { type: String, default: "" },

}, { _id: false }); // le decimos a Mongoose que no autogenere _id
